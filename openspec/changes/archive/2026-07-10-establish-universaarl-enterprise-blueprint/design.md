# Loesungsdesign: Universaarl-Unternehmens-Blueprint v0.1
...
- Ein Lagerplatz ist die feinere physische Struktur innerhalb eines Lagerorts; `Bin Mandatory` und Lagerfunktionen werden pro Lagerort festgelegt.
...
- Produktkonfiguration bleibt bewusst standardnah. Barcode/WMS, PLM, Reisekosten, Entgeltabrechnung und Field-Service-Mobile-App sind Entscheidungspunkte, keine zugesagten Integrationen.
...
Vier rechtliche operative Gesellschaften erhalten je ein BC-Unternehmen; ein fuenftes, nicht operatives BC-Unternehmen dient der Konsolidierung. UAM-DE ist eine substanzielle Holding-/Shared-Service-Gesellschaft mit Beteiligungen, HQ-Assets, eigenen Mitarbeitern, Bank-/Steuerstruktur sowie Finanz-, IT- und Data-Governance-Leistungen auf Basis dokumentierter Servicevereinbarungen und Umlageschluessel. UAP-DE schliesst eigene Projektvertraege, beschaeftigt eigene Ressourcen und traegt Projekt-, WIP-, Forderungs- und Subunternehmerrisiken sowie eine eigene Bank-/Steuerstruktur. Reale Steuer-IDs, Bankdaten und Rechtsauskuenfte sind nicht Bestandteil des synthetischen Blueprints.
...
| Shared Services | Finanzwesen, IT, HR-Administration | Konzerninterne Umlage/Servicefaktura | UAM-DE |
...
| --- | --- | --- | --- | --- |
| Universaarl Management GmbH | `UAM-DE` | Holdingnahe Shared Services, zentrale Finanz-/IT-Kosten, Anlagen HQ | Ja | Saarbruecken / EUR |
...
Entscheidung DEC-003: Unterschiedliche Lagerkomplexitaetsstufen bleiben bewusst parallel, weil Volumen und Kontrollbedarf verschieden sind. Alternative "Advanced Warehouse ueberall" wird wegen Schulungs-, Einrichtungs- und Prozessaufwand verworfen.
...
| --- | --- | --- | --- | --- |
| P-001 | Dr. Lena Hartmann | UAM-DE | Geschaeftsfuehrerin, Sponsorin | Gibt Blueprint/Cutover frei; keine operative Buchung. |
| P-002 | Jonas Weber | UAM-DE | Programmleiter / Loesungsverantwortlicher | Change-Verantwortung und Architekturkoordination; kein Zahlungsfreigeber. |
| P-003 | Miriam Schaefer | UAM-DE | Konzern-CFO / Konsolidierung | Freigabe Zahlungslaeufe und Konzernabschluss; keine Lieferantenanlage. |
...
| P-009 | Svenja Roth | UAS-DE | Lagerleitung Werk | Advanced Warehouse und Inventur; keine Einkaufsfreigabe. |
| P-010 | David Nguyen | UAD-DE | Vertriebsleiter DACH | Preis-/Rabattfreigabe und Verantwortungszentrum `RC-SALES-DACH`. |
| P-011 | Nina Becker | UAD-DE | Kunden- und Lieferabwicklung | Angebote/Auftraege und operative Ersatzteilbestellung; Preis- und Einkaufsfreigaben bleiben bei P-010 bzw. Limits/Workflow. |
| P-012 | Cem Yildiz | UAD-DE | Serviceleiter | Servicevertraege und Eskalation; verantwortet `TR-SVC`, keine FiBu-Buchung. |
| P-013 | Paula Hoffmann | UAD-DE | Servicetechnikerin / Service-Datenverantwortliche | Serviceauftraege, `VAN-01` und operative Pflege gepruefter Serviceartikeldaten; P-012 bleibt fachlich rechenschaftspflichtig. |
...
| P-015 | Sophie Martin | UAP-DE | Projektbuchhalterin / Trainingskoordination | Projektfaktura und Trainingskoordination; trainiert Projekte, nimmt aber weder fremde Module noch UAT allein ab. |
| P-016 | Erik Schneider | UAM-DE | Data Steward | Kunden/Lieferanten-Governance gruppenweit; keine Zahlungen oder Belege. |
| P-017 | Julia Koenig | UAS-DE | Finanzbuchhalterin / Finanz-Key-User | Operative UAS-FiBu und Reconciliation; P-006 kontrolliert Kosten, P-003 gibt Zahlungen frei. |
| P-018 | Martin Reuter | UAD-DE | Finanzbuchhalter / Finanz-Key-User | Operative UAD-FiBu und Reconciliation; keine Preis-/Kreditfreigabe. |
| P-019 | Selin Acar | UAD-DE | Distributionslager-Koordination / Key User | Verantwortet `SLS-DC`, Inventur und Basic-Warehouse-Training; keine Einkaufs- oder FiBu-Freigabe. |

Kleine-Gesellschaft-Ausnahme: Aylin Demir betreut UAM und UAP operativ. Kompensierende Kontrollen sind unternehmensspezifische Rechte, CFO-Freigabe fuer Zahlungen und monatliche Aenderungspruefung kritischer Stammdaten. UAS und UAD erhalten mit P-017 und P-018 eigene operative Finanzverantwortung; P-006 bleibt Controller und ersetzt keine Kreditoren-/Debitorenverarbeitung.

## 7. Prozess- und Faehigkeitenmatrix
...
Wellen: W0 Blueprint; W1 Grundlagen plus Workstream-Strategien; W2 Handel/Basislogistik plus Mock Load 1; W3 Betrieb plus Mock Load 2/Integration; W4 UAT/Konzernabschluss/Cutover-Probe; W5 finaler Load/Training/Cutover/Hypercare. Daten, Tests, Training und Adoption laufen projektbegleitend durch W1-W5.

| Faehigkeit / E2E | Geschaeftszweck | Zielgesellschaft / Standort | Primaere Rolle | Abhaengigkeiten | Welle | Geplanter Nachweis |
| --- | --- | --- | --- | --- | --- | --- |
| Finanzwesen / Record-to-Report | Lokalisierte, pruefbare Haupt- und Nebenbuecher, Periodenabschluss | alle operativen; UAM HQ | P-005 UAM/UAP, P-017 UAS, P-018 UAD; P-003 Freigabe | Kontenplan, Buchungsgruppen, Dimensionen, Steuern | W1 | `UABC-SCN-FIN-001`: Beleg -> Nebenbuch -> Sachposten -> Abschlusscheck, UI+Posten-Evidence |
...
| Anlagen / Acquire-to-Retire | Maschinen, Pruefmittel, Fahrzeuge und IT-Anlagen abschreiben | UAM/UAS/UAD | P-005, P-006 | Finanzwesen, Anlagenklassen, AfA-Buecher | W3 | `UABC-SCN-FA-001`: Zugang -> AfA-Vorschlag -> Buchung -> Abgang |
...
| Administration und Sicherheit | Least Privilege, Jobs, E-Mail und auditierbare Aenderungen | Umgebung + alle Unternehmen | P-004 | Entra, Lizenzen, Permission Sets, Monitoring | W1 | `UABC-SCN-SEC-002`: Rollenlogin, erlaubte/verbotene Aktion, Audit-Evidence |
| Datenmigration | Setup, Stamm-, offene und historische Daten kontrolliert klassifizieren, wiederholt laden und abstimmen | alle operativen | P-016 koordiniert; P-005/P-017/P-018/P-006 reconciliieren | Inventar, Verantwortliche, Mapping, Bereinigung, Standardwerkzeuge, Reconciliation | W1-W5 | Strategie -> Mock 1 -> Mock 2 -> UAT-Lauf -> finaler Load mit objektbezogenen Counts/Totals |
| Tests, UAT, Training und Adoption | Prozesse frueh pruefen, durch Fachbereichsverantwortliche abnehmen und Rollen fuer Go-live befaehigen | alle Rollen/Standorte | P-002 Testkoordination; P-015 Trainingskoordination; modulare Key User/Verantwortliche | repraesentative Daten, verifizierte Szenarien, Defect-Gates, Lernziele | W1-W5 | Testplan -> integrierte Tests -> UAT -> Train-the-Trainer -> Endanwendercheck/Adoption |
...
Reporting-Ziel: Financial Reports, Dimensionspruefung und Analysis Views beginnen in W1 als lokale Finanzkontrolle; Konzernreporting folgt in W4 nach IC-Abstimmung und Konsolidierung. Power BI bleibt eine optionale lesende Managementschicht nach Datenqualitaetsnachweis. Jede Kennzahl benennt Verantwortlichen, Definition, Aktualisierung, Berechtigungsniveau und Drilldown bis BC-Beleg/Posten.

## 9. Sicherheit und interne Kontrollen

### Zielmodell

1. Entra-Sicherheitsgruppen steuern Umgebungszugang und rollenbasierte Gruppierung.
2. BC-Berechtigungssaetze geben die kleinste erforderliche Funktion; Zuweisung je BC-Unternehmen, falls nicht gruppenweit erforderlich.
...
| Integration | Zweck | Datenverantwortung | Entscheidung v0.1 | Nachweis/Reset spaeter |
| --- | --- | --- | --- | --- |
...
| Barcode/WMS-App | Scanunterstuetzung `NK-WERK` | P-009 | Make-or-buy offen; BC-Standardprozess zuerst beweisen | Sandbox-PoC und Deinstallations-/Resetplan |

Keine Integration erhaelt im Blueprint eine technische Erfolgsbehauptung.

## 11. Datenverantwortung

| Domaene | Fachlich verantwortlich | Ausfuehrend verantwortlich | Qualitaetsregel |
| --- | --- | --- | --- |
...
| Lager/Bins/Bestand | P-009 UAS / P-019 UAD | lokale Lager-Key-User; P-012/P-013 fuer Service/Fahrzeug | Physischer Count und BC-Menge abstimmbar |
| Projekte/Ressourcen | P-014 | P-015 | Vertrag, Budget, Fakturamethode und Dimensionen freigegeben |
...
| Gebuchte Historie | Nicht als scheinbar operative Historie per Configuration Package nachbauen. Altarchiv zugreifbar halten oder nur nach eigener Audit-/Umfangsentscheidung migrieren. | Vollstaendigkeit, Aufbewahrung, Datenschutz und Audit-Trail durch Recht/Finanzwesen bestaetigen. |
...
| Finanzwesen | P-003, P-005, P-006, P-017, P-018 | R2R, P2P/O2C-Buchungswirkung, Abschluss und Reconciliation je Gesellschaft | P-005/P-017/P-018 liefern lokale Uebungen; P-003/P-006 pruefen Kontrolle und Abschluss |
| Sales & Customer Service | P-010, P-011 | Quote-to-Cash, Preise, Verfuegbarkeit, Kredit | Rollenlab; Auftrag fehlerfrei abgeschlossen |
| Lager und Versorgung | P-007, P-009, P-019 | Beschaffung, Receive/Put-away/Pick/Ship, Inventur | P-009 trainiert UAS Advanced; P-019 UAD Basic; Standortuebungen getrennt |
| Fertigung | P-008, P-006 | Planung, Verbrauch, Output, Kosten | Fertigungsfall mit Soll/Ist-Erklaerung |
| Projekte | P-014, P-015 | Budget, Zeit/Material, WIP, Faktura | P-014 Prozess/P-015 Finanzwesen; Projektfall und Monatsabschluss |
...
P-015 fuehrt den Trainingskalender, die Methodik und Materialqualitaet. Sie ist weder alleinige Fachtrainerin noch UAT-Abnehmerin: Finanzwesen, Einkauf, Vertrieb, Lager, Fertigung, Projekte, Service und Administration werden jeweils von den oben benannten Prozessverantwortlichen/Key Usern trainiert und fachlich abgenommen.
...
- DEC-007: Dataverse/Dynamics 365 Sales ist nicht Teil des Kernprojekts; ein spaeterer Einsatz braucht einen positiven Geschaeftsfall und separaten OpenSpec-Change. Native BC-nahe Vertriebsfunktionen duerfen im Vertriebsumfang geprueft werden.
- DEC-008: UAM-DE ist alleinige Quellgesellschaft fuer die geplante Standardsynchronisation; gemeinsamer kommerzieller Kern in UAM, Produktionsengineering in UAS und transaktionale/rechtliche Felder lokal.
...
| UABC-OQ-006 | decided via `UABC-DEC-007` | `sponsor-decision` | CRM/Dataverse im Geschaeftsumfang? | P-010 | ausserhalb Kernprojekt; separater Change nach positivem Geschaeftsfall |
| UABC-OQ-007 | open | `legal-tax-licensing-review` | E-Rechnungsformat, Provider und Aufbewahrung? | P-003 | Rechts-/Steuer-/Provider-Review und Sandboxnachweis |
...
Die Freigabe umfasst Unternehmens-/Loesungsarchitektur, Faehigkeitenplan, W1-W5-Liefermodell, Rollen/Kontrollen und offene Fragen mit Gates. Sie bestaetigt keine tatsaechliche `playthru`-Version oder Featureverfuegbarkeit, keine Rechts-/Steuer-Detailauslegung, keine finale Lizenzzuweisung, keine einzelne Faehigkeitsvalidierung, keine W1-Writes und kein Go-live.

### Findings nach Schweregrad

#### Hoch

1. **Rechtstraegermodell synthetisch festgelegt, Detailreview offen.** UAM ist als substanzielle Holding-/Shared-Service-Gesellschaft und UAP als eigenstaendige Projektvertragsgesellschaft beschlossen. Reale gesellschafts-, steuer- und bankrechtliche Ausgestaltung bleibt Rechts-/Steuer-Gate; `UAC-CONS` bleibt nicht-operatives BC-Unternehmen und kein Rechtstraeger.
2. **Premium ist eine Architekturabhaengigkeit.** UAS-DE benoetigt Premium fuer Manufacturing, UAD-DE fuer Service Management. Essentials-Nutzer koennen nicht in Premium-Unternehmen arbeiten. Die Lizenzmatrix muss deshalb personen- und unternehmensbezogen vor dem Sicherheitsdesign entschieden werden; SUPER oder Permission Sets erweitern keine Lizenzberechtigungen.
...
4. **Stammdatenpolicy beschlossen, Feldnachweis offen.** UAM ist einzige Quellgesellschaft fuer Parteienidentitaet, gemeinsame Dictionaries und den kommerziellen Artikelkern. UAS fuehrt Production BOMs, Routings, Kapazitaeten und Engineering lokal; Gesellschaften fuehren Steuer-, Buchungs-, Kredit-, Preis-, Einkaufs-, Standort- und Planungsfelder. Feldmatrix und `playthru`-PoC bleiben W1-Gates.
5. **Der Handelsumfang war unvollstaendig.** Kunden-/Lieferantenretouren, Preis-/Rabattgovernance und Vorauszahlungen waren nicht als eigenstaendige Faehigkeit erkennbar. Vorauszahlungen sind fuer kundenspezifische PANEL-Auftraege und ausgewaehlte Projektvertraege jetzt `planned`; sie ersetzen weder Projekt-WIP noch Meilensteinfakturierung.
6. **Intercompany benoetigt ein kaufmaennisches Betriebsmodell.** UAS -> UAD Produktlieferung, UAD -> UAP Material und UAM -> Gruppe Shared Services sind plausibel. Offen sind Transferpreise, Markups, Leistungsnachweis, Eigentumsuebergang, Gegenkonten, IC-Artikelnummern, Retouren/Garantie und Abstimmung. Kombinierte Geschaefte brauchen eine eindeutige Lead-Contractor- und Fakturagrenze zwischen UAD und UAP.
...
3. **Projekt-WIP ist vertragsabhaengig.** Ressourcen und Planning Lines sind plausibel; WIP-Methode, Erloesrealisierung und Fakturatrigger duerfen erst nach Vertragsmustern festgelegt werden.
...
5. **Dimensionsmodell braucht Buchungsregeln.** `COSTCENTER` und `BUSINESSUNIT` bleiben empfohlen. Default Dimensions, Prioritaeten, Pflichtwerte und erlaubte Kombinationen muessen je Stammdatentyp festgelegt werden. `PROJECT` dient nur Querschnittsanalyse und ersetzt nie BC-Projekte.
...
9. **Lieferarbeitsstroeme waren unrealistisch spaet.** Daten, Tests, UAT, Training, Adoption, Cutover und Hypercare sind jetzt projektbegleitend. W4 enthaelt Reconciliation, formale Fachbereichs-UAT, Train-the-Trainer und Cutover-Probe; nur finaler Load, Endanwendertraining, Ausfuehrung und Hypercare bleiben W5.
...
2. Zwei AfA-Buecher koennen Handels-/Steueranforderungen abbilden, sind aber keine automatische Empfehlung ohne Steuerreview.
...
- Vier substanzielle Rechtstraeger plus nicht-operatives `UAC-CONS` beibehalten; reale Rechts-/Steuerdetails separat pruefen.
...
- `COSTCENTER` und `BUSINESSUNIT` als globale Dimensionen beibehalten; Pflicht-/Default-/Kombinationsregeln vor erster Buchung entwerfen.
...
- NK-WERK Advanced Warehouse als W3-Zielhypothese nach Stabilisierung des Basishandels behandeln; SLS-DC Basic, Depot/Fahrzeuge/Projektlager einfach belassen.
...
1. Rechts-/Steuerpruefung der synthetisch festgelegten Gesellschaftsstruktur, Servicevereinbarungen und Umlageschluessel; keine realen VAT IDs oder Bankdaten im Blueprint.
...
12. Migrationsumfang je Datenobjekt: Quelle, Volumen, Historie, Qualitaet, Transformation, Reconciliation und Aufbewahrung.
