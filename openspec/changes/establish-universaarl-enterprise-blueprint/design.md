...
Vier rechtliche operative Gesellschaften erhalten je ein BC-Unternehmen; ein fuenftes, nicht operatives BC-Unternehmen dient der Konsolidierung. Das schafft glaubwuerdige Intercompany- und Konzernprozesse, ohne jede Geschaeftseinheit kuenstlich zu verselbstaendigen.
...
`UAM-DE` besitzt die Beteiligungen. UAS verkauft Fertigprodukte konzernintern an UAD; UAP bezieht Material von UAD und Engineering-Komponenten von UAS; UAM berechnet Shared Services. Externe Serienproduktkunden werden grundsaetzlich durch UAD bedient, projektbezogene Kunden durch UAP.
...
| P-011 | Nina Becker | UAD-DE | Customer Service / Sales Ops | Angebote und Auftraege; darf innerhalb Freigabegrenzen Rabatte pflegen. |
| P-012 | Cem Yildiz | UAD-DE | Serviceleiter | Servicevertraege und Eskalation; verantwortet `TR-SVC`, keine FiBu-Buchung. |
| P-013 | Paula Hoffmann | UAD-DE | Servicetechnikerin | Serviceauftraege und `VAN-01`; zaehlt Fahrzeugbestand. |
...
| P-015 | Sophie Martin | UAP-DE | Project Accountant / Trainerin | Projektfaktura und Key-User-Training; keine Projektbudgetfreigabe. |
| P-016 | Erik Schneider | UAM-DE | Data Steward | Kunden/Lieferanten-Governance gruppenweit; keine Zahlungen oder Belege. |

Kleine-Gesellschaft-Ausnahme: Aylin Schaefer betreut UAM und UAP operativ. Kompensierende Kontrolle sind unternehmensspezifische Rechte, CFO-Freigabe fuer Zahlungen und monatliche Aenderungspruefung kritischer Stammdaten.

## 7. Prozess- und Capability-Matrix

Die folgende Tabelle ist eine kompakte Review-Sicht. Der kanonische, hierarchische und maschinenpruefbare Katalog ist `UABC-CAP-CATALOG-001` unter `capabilities/catalog.yaml`; Jira erzeugt daraus keine Tickets.

Wellen: W0 Blueprint; W1 Foundation/Finance/Admin; W2 Trade/Inventory/Warehouse; W3 Manufacturing/Projects/Service/Assets; W4 Intercompany/Consolidation/Reporting; W5 Migration/UAT/Training/Cutover.

| Capability / E2E | Geschaeftszweck | Zielgesellschaft / Standort | Primaere Rolle | Abhaengigkeiten | Welle | Geplanter Nachweis |
| --- | --- | --- | --- | --- | --- | --- |
| Finance / Record-to-Report | Lokalisierte, pruefbare Haupt- und Nebenbuecher, Periodenabschluss | alle operativen; UAM HQ | P-005, P-003 | Kontenplan, Buchungsgruppen, Dimensionen, Steuern | W1 | `UABC-SCN-FIN-001`: Beleg -> Nebenbuch -> Sachposten -> Abschlusscheck, UI+Posten-Evidence |
| Cash & Bank / Pay-to-Reconcile | Sichere Zahlungen und Bankabstimmung | alle operativen | P-005 vorbereitet, P-003 genehmigt | Banken, Zahlungsformate, Genehmigung, SoD | W1 | `UABC-SCN-FIN-002`: Zahlungsvorschlag, Freigabe, Export-Simulation, Abstimmung |
| Einkauf / Procure-to-Pay | Material und Leistung bedarfsgerecht beschaffen | UAS Werk; UAD DC; UAP Projekte | P-007 | Lieferanten, Artikel/Ressourcen, Genehmigungen, Finance | W2 | `UABC-SCN-P2P-001`: Bestellung -> Wareneingang -> Rechnung -> Zahlung |
...
| Bestand | Verfuegbarkeit, Umlagerung, Inventur und Bewertung | UAS/UAD/UAP-Lagerorte | P-009 | Artikel, Lagerorte, Posting Setup | W2 | `UABC-SCN-INV-001`: Umlagerung + Inventurdifferenz + Bewertungsabgleich |
| Lager | Standortgerechter Empfang, Einlagerung, Pick und Versand | NK-WERK/NK-PROD/SLS-DC/TR-SVC/VAN | P-009, P-013 | Bestand, Bins, Rollen, Belegprozesse | W2 | `UABC-SCN-WHS-002`: je Lagerklasse eigener UI-Weg und Bestandsnachweis |
...
| Service / Service-to-Cash | Installierte Basis, Wartung, Reparatur und Ersatzteile steuern | UAD TR-SVC/VAN | P-012, P-013 | Serviceartikel, Bestand, Ressourcen, Verkauf | W3 | `UABC-SCN-SVC-001`: Vertrag/Call -> Auftrag -> Verbrauch -> Faktura |
...
| Intercompany / IC-to-Reconcile | Produkte und Shared Services ohne Doppelerfassung austauschen | UAS<->UAD/UAP; UAM->alle | P-005, P-003 | IC-Partner, Konten-/Dimensionsmapping, Masterdaten | W4 | `UABC-SCN-IC-001`: Ausgang -> Inbox -> Gegenbeleg -> Abstimmung |
...
| Reporting | Management-GuV, Working Capital, Projekt- und Serviceprofitabilitaet | konzernweit | P-003, P-006, Bereichsleiter | Datenqualitaet, Dimensionen, Analysis Views/Power BI | W4 | `UABC-SCN-RPT-001`: Bericht -> Drilldown -> Gesellschafts-/Belegabgleich |
...
| Datenmigration | Kontrollierte Uebernahme von Stammdaten, Salden und offenen Posten | alle operativen | P-016, P-005 | Datenowner, Mapping, Bereinigung, Reconciliation | W5 | `UABC-SCN-DATA-001`: Ladeprotokoll, Counts/Totals, Fehlerliste, Sign-off |
| Training & Adoption | Rollen koennen freigegebene Prozesse sicher ausfuehren | alle Rollen/Standorte | P-015, Key User | verifizierte Szenarien, UAT, Lernziele | W5 | `UABC-SCN-TRN-001`: Lerncheck + beobachtete Aufgabe + Feedback/Sign-off |
...
Reporting-Ziel: Financial Reports und Analysis Views fuer lokale Finance; Power BI nur als lesende Managementschicht nach Datenqualitaetsnachweis. Jede Kennzahl benennt Owner, Definition, Refresh, Berechtigungsniveau und Drilldown bis BC-Beleg/Posten.
...
| --- | --- | --- | --- |
| Konten, Steuern, Buchungsgruppen | P-003 | P-005 | Freigegebenes Mapping, Vier-Augen-Pruefung, Testbuchung |
...
| Lager/Bins/Bestand | P-009 | Warehouse Key User | Physischer Count und BC-Menge abstimmbar |
| Projekte/Ressourcen | P-014 | P-015 | Vertrag, Budget, Billing Method und Dimensionen freigegeben |
| Serviceartikel/Vertraege | P-012 | Service Coordinator | Seriennummer, Kunde, Standort und SLA konsistent |
| Rollen/Berechtigungen | P-004 | P-004 | Owner-Genehmigung, Least Privilege, SoD-Test |

Migration folgt Extract -> Profile -> Cleanse -> Map -> Trial Load -> Reconcile -> Approve -> Cutover Load. Konfigurationspakete oder APIs sind fuer Arrange/Migration erlaubt, werden aber mit Quelle, Transformationsregel, Lauf-ID und Fehlerdatei dokumentiert.
...
| Finance | P-003, P-005, P-006 | R2R, P2P/O2C-Buchungswirkung, Abschluss | Prozesslabs; Postenketten und Kontrollen erklaert |
| Sales & Customer Service | P-010, P-011 | Quote-to-Cash, Preise, Verfuegbarkeit, Kredit | Rollenlab; Auftrag fehlerfrei abgeschlossen |
| Warehouse & Supply | P-007, P-009 | Beschaffung, Receive/Put-away/Pick/Ship, Inventur | Standortlabs Basic/Advanced getrennt |
| Manufacturing | P-008, P-006 | Planung, Verbrauch, Output, Kosten | Fertigungsfall mit Soll/Ist-Erklaerung |
| Projects | P-014, P-015 | Budget, Zeit/Material, WIP, Faktura | Projektfall und Monatsabschluss |
| Service | P-012, P-013 | Installed Base, Auftrag, Teile, Faktura | Servicefall inkl. Fahrzeuglager |
| Admin & Data | P-004, P-016 | Rechte, Monitoring, Datenqualitaet, Migration | Runbook-Uebung und Fehlerbehebung |
...
### Offene Entscheidungen (nicht stillschweigend angenommen)

| ID | Frage | Owner | Spaeteste Entscheidung | Benoetigte Evidence |
| --- | --- | --- | --- | --- |
| OQ-001 | Exakte `playthru` BC-Version, Land, Apps und Kapazitaet? | P-004 | vor W1 | Environment-/Company-Screenshot und Admin-Export |
| OQ-002 | SKR03, SKR04 oder Universaarl-Kontenplan mit Mapping? | P-003 | W1 Design | Finance-Workshop, Reporting-/Steueranforderungen |
| OQ-003 | Costing je Produktfamilie und Standardkostenprozess? | P-006 | vor W2 Artikelsetup | Margenmodell und Produktionssimulation |
| OQ-004 | Serien-/Chargenpflicht je Produkt? | P-012/P-006 | vor W2 | Gewaehrleistung, Rueckverfolgung, Serviceprozess |
| OQ-005 | Advanced Warehouse Standard ausreichend oder Scanner-App? | P-009 | nach Standard-PoC W2 | gemessene Laufwege/Fehler und Sandbox-PoC |
| OQ-006 | CRM/Dataverse im Scope? | P-010 | W4 Planung | Lead-/Account-Prozess und Integrationsnutzen |
| OQ-007 | E-Rechnungsformat/Provider und Aufbewahrung? | P-003 | W1/W2 | Rechts-/Providerworkshop, Sandboxfaehigkeit |
| OQ-008 | Projekt-WIP- und Fakturierungsmethode je Vertragstyp? | P-014/P-003 | vor W3 | Vertragsmuster und Monatsabschlussanforderung |
