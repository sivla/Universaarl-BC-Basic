...
- [ ] 2.1 Exakte Gesellschaft binden, Grundeinrichtung und minimale Rollen konfigurieren (`UABC-27`, 4 h).
- [ ] 2.2 Finanzwesen, SKR04, Konten, Buchungsgruppen, MwSt. und Dimensionen konfigurieren (`UABC-28`, 10 h).
- [ ] 2.3 Konfigurationspakete erstellen, freigegebene Stammdaten kontrolliert importieren und abstimmen (`UABC-29`, 4 h).
- [ ] 2.4 Einkaufsprozess konfigurieren und durchspielen (`UABC-30`, 5 h).
- [ ] 2.5 Verkaufsprozess konfigurieren und durchspielen (`UABC-31`, 5 h).
- [ ] 2.6 Einfaches Lager und Bestand konfigurieren und durchspielen (`UABC-32`, 5 h).
- [ ] 2.7 Rollenbezogene Schulungen protokollieren (`UABC-33`, 4 h).
- [ ] 2.8 Playwright-Ende-zu-Ende-Pflichtfaelle, fachlichen Abnahmetest, UAT-Begleitung und Nachweise durchfuehren (`UABC-34`, 3 h).

## 3. Phase 3 - Einwoechige Hypercare

- [ ] 3.1 UAT- und Hypercare-Befunde priorisieren und begrenzt bearbeiten (`UABC-35`, 2 h).
- [ ] 3.2 Monatsabschlussprozess in der Sandbox proben und Abstimmungen dokumentieren (`UABC-36`, 3 h).
- [ ] 3.3 UStVA-Vorschau fachlich pruefen, aber nicht uebermitteln (`UABC-37`, 2 h).
- [ ] 3.4 Schulungsunterlagen, Projektdokumentation und Uebergabe abschliessen (`UABC-38`, 3 h).
