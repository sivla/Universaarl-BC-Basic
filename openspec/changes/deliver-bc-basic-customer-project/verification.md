...
Der fachliche V1-Realitaetscheck vereinheitlicht den Referenzfall auf `UABC-BASIC-DE`, Artikel `A-1000`, Buchungsgruppen `INLAND`/`HANDEL`/`MWST19`, Dimensionen `KOSTENSTELLE`/`GESCHAEFT` und FIFO. Elf synthetische Kontenrollen und sechs Buchungsmatrizen loesen alle verwendeten G/L-Entries auf. Der fokussierte Playthrough prueft sieben Sitzungen, 16 Dokumente und 35 Entries; O2C ergibt 790,00 EUR netto, 150,10 EUR USt und 940,10 EUR brutto. Neue P2P-/O2C-Posten sind ausgeglichen, die offenen Eroeffnungsposten bleiben mit 940,10 EUR Debitor und 499,80 EUR Kreditor sichtbar. Bank 5.440,30 EUR, Lager 99 STK/4.158,00 EUR, VAT-Zahllast 70,30 EUR und Schlussbilanz 11.080,20 EUR je Seite sind rechnerisch abgestimmt. Auftraege werden von gebuchten Belegen getrennt; UAT und Training trennen Kundenplan von bestandener Referenzsimulation.
