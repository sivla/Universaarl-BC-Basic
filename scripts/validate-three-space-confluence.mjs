...
export function validateThreeSpace({contract,index,story,readText=(path)=>fs.readFileSync(path,'utf8')}){
  ...
  if(contract?.consumerProducerBranch!=='codex/universaarl-projekt'||index?.allowedBranch!=='codex/universaarl-projekt'||index?.deliveryBranch!=='codex/universaarl-projekt'||contract.deliveryBranch!=='codex/universaarl-projekt')fail('BRANCH-VERTRAG','Producer-, Delivery- und Consumerbranch muessen kanonisch codex/universaarl-projekt sein');
