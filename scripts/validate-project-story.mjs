...
const validateCanonicalStory = (story, { checkFiles = true, metadataReader = null } = {}) => {
  ...
  if (story.offer?.planned_hours !== 80 || story.offer?.actual_hours !== 80 || story.offer?.planned_cost !== 9600 || story.offer?.actual_cost !== 9600 || story.activeOffer?.actualHours !== 80 || story.activeOffer?.actualNetAmount !== 9600) fail('WORKLOG-SUMME', '80 Stunden und 9.600 EUR muessen als Simulation konsistent sein');
  ...
  if (hours !== 80 || amount !== 9600) fail('WORKLOG-SUMME', `${hours}/${amount}`);
