...
'UABC-39':'UABC-BASIC-DE wird als unveränderte Standard-CRONUS-Demo-Ausgangsbasis gelesen. Interne Company-ID, technischer Name, Name, Display Name, CRONUS-Provenienz, Resetpunkt und die Entscheidung Weiterverwenden oder Neuanlage beziehungsweise Kopie sind vor jedem Setup-Write zu belegen.',
