...
const EXACT_STRUCTURED_VALUE_EXCEPTIONS = new Map([
  ...
  ['governance/production-readiness.json\u001f$.assessments.platformReady.evidence[2].kind\u001frelease-evidence', 'gebundener-evidence-typ'],
  ['governance/production-readiness.json\u001f$.assessments.onboardingReady.evidence[1].kind\u001finput-contract', 'gebundener-evidence-typ'],
  ['governance/production-readiness.json\u001f$.assessments.onboardingReady.evidence[5].kind\u001freadiness-validation', 'gebundener-evidence-typ'],
  ['governance/production-readiness.json\u001f$.truthBoundary.atlassian\u001frepository-simulated-or-manually-materialized', 'gebundener-atlassian-modus'],
