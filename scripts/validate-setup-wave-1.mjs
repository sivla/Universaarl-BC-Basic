...
if (process.argv[1]?.endsWith('validate-setup-wave-1.mjs')) {
  ...
  else console.log('Setup-Wave-1-Pruefung bestanden: exakte CORE-Allowlist, aufgeloeste Quellen, Singletonwerte und fail-closed Write-Schritte; kein Live-Run.');
}
