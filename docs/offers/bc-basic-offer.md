...
**Aktuelles Ist:** 0,25 Stunden, 30 EUR, ein Task-Worklog auf `UABC-39`; keine Rechnung oder Zahlung.

## Versionen und Nachweisgrenze

- **Aktiver Pilot-Rebaseline-Stand, 13.07.2026:** `planned-not-accepted`; Plan 80 Stunden/9.600 EUR, Ist 0,25 Stunden/30 EUR aus einem aktiven Task-Worklog.
