...
- Fuer den portablen Snapshotvertrag ist zusaetzlich Spectra `1.2.0-alpha.12` ueber `spectra-v1.2.0-alpha.12`, das annotierte Tagobjekt `80563e5823a042a95582c88cb41aaf6306a9cfce`, den peeled Commit `6b3d9a1bfaf6cd806218a802fdde8f1a4cfa55a1`, das finale Manifest, den Payload-Digest `b637a82c381d7744f08949c264393382cb90d7e6b1f67d56afacb6e88a312c7b` und die bestandene Windows-/macOS-Matrix in `evidence/spectra-release-1.2.0-alpha.12.yaml` gebunden. Diese neuere Snapshotbindung ersetzt keine historische 0.10-Konformitaetsevidence und veraendert den ungebundenen Release `UABC-PORTABLE-PILOT-0001` nicht.
